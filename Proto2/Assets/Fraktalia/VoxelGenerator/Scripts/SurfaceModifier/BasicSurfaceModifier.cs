...
namespace Fraktalia.VoxelGen.Visualisation
{
	...
	public class BasicSurfaceModifier : MonoBehaviour
	{
		...
		protected VoxelPiece CreateVoxelPiece(string Name, Material material)
		{
			...
			if (usedHideflags == HideflagsMode.Normal) newgameobject.hideFlags = HideFlags.None;
			if (usedHideflags == HideflagsMode.DontSave) newgameobject.hideFlags = HideFlags.DontSave;
			if (usedHideflags == HideflagsMode.Hidden) newgameobject.hideFlags = HideFlags.HideInHierarchy;
			if (usedHideflags == HideflagsMode.HiddenDontSave) newgameobject.hideFlags = HideFlags.HideAndDontSave;
