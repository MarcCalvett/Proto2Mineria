    ...
    public class PipeExtruderEditor : Editor
    {
        ...
        public void OnSceneGUI()
        {
            ...
            for (int i = 0; i < pos.Length; i++)
            {
                ...
                var fmh_35_57_638343858099750381 = mytarget.transform.localRotation * Quaternion.Euler(90, 0, 0); pos[i] = Handles.FreeMoveHandle(pos[i], 0.2f, Vector3.zero, Handles.CircleHandleCap);
